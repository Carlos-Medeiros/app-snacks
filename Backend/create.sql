...
create table tb_delivaryman_email_validation (email varchar(255) not null, email_master varchar(255), number_validation int4, primary key (email));
create table tb_deliveryman (id int8 generated by default as identity, email varchar(255), name varchar(255), password varchar(255), phones int8, primary key (id));
